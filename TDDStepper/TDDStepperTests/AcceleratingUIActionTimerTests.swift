...
class AcceleratingUIActionTimerTests: XCTestCase {
    ...
    // MARK: - Helpers
    private func makeSUT(accelerationInterval: AcceleratingUIActionTimer.AccelerationInterval = .zero, timers: [UIActionTimer], file: StaticString = #filePath, line: UInt = #line) throws -> AcceleratingUIActionTimer {
